// floor7.js (cine-style reservar y confirmar + modo edición + modo cancelar)
(() => {
  ...
  if (!seatsLayer || !floorMap || !datePick || !btnBackHome || !sideMsg) {
    console.warn("[floor7] faltan elementos en HTML");
    return;
  }
  ...
  // ==========================
  const SEATS_7 = [
    { id: "7-01", x: 7.2, y: 32.8 },
    { id: "7-02", x: 12.4, y: 32.8 },
    { id: "7-03", x: 17.5, y: 33.0 },
    { id: "7-04", x: 22.1, y: 33.5 },
    { id: "7-05", x: 6.6, y: 39.3 },
    { id: "7-06", x: 12.5, y: 39.9 },
    { id: "7-07", x: 17.4, y: 40.0 },
    { id: "7-08", x: 22.0, y: 40.2 },
    { id: "7-09", x: 6.3, y: 58.2 },
    { id: "7-10", x: 11.5, y: 58.3 },
    { id: "7-11", x: 16.6, y: 58.7 },
    { id: "7-12", x: 21.6, y: 59.2 },
    { id: "7-13", x: 6.3, y: 63.6 },
    { id: "7-14", x: 11.5, y: 63.8 },
    { id: "7-15", x: 16.7, y: 64.3 },
    { id: "7-16", x: 21.6, y: 65.0 },
    { id: "7-17", x: 31.1, y: 64.1 },
    { id: "7-18", x: 36.2, y: 64.1 },
    { id: "7-19", x: 41.1, y: 63.9 },
    { id: "7-20", x: 45.8, y: 63.9 },
    { id: "7-21", x: 50.3, y: 63.8 },
    { id: "7-22", x: 31.4, y: 67.8 },
    { id: "7-23", x: 36.3, y: 67.6 },
    { id: "7-24", x: 41.2, y: 67.6 },
    { id: "7-25", x: 46.0, y: 67.5 },
    { id: "7-26", x: 50.3, y: 67.4 },
    { id: "7-27", x: 31.7, y: 86.3 },
    { id: "7-28", x: 36.2, y: 86.0 },
    { id: "7-29", x: 41.0, y: 85.7 },
    { id: "7-30", x: 46.0, y: 85.6 },
    { id: "7-31", x: 50.4, y: 5.7 },
    { id: "7-32", x: 31.9, y: 9.3 },
    { id: "7-33", x: 36.2, y: 9.0 },
    { id: "7-34", x: 41.3, y: .9 },
    { id: "7-35", x: 45.9, y: 9.0 },
    { id: "7-36", x: 50.3, y: .7 },
    { id: "7-37", x: 60.1, y: 63.9 },
    { id: "7-38", x: 64.3, y: 63.9 },
    { id: "7-39", x: 69.2, y: 63.9 },
    { id: "7-40", x: 60.4, y: 66.9 },
    { id: "7-41", x: 64.6, y: 67.0 },
    { id: "7-42", x: 69.0, y: 66.9 },
    { id: "7-43", x: 60.2, y: 5.5 },
    { id: "7-44", x: 64.7, y: 5.6 },
    { id: "7-45", x: 69.5, y: 5. },
    { id: "7-46", x: 74.1, y: 5.6 },
    { id: "7-47", x: 79.0, y: 5.6 },
    { id: "7-48", x: 60.4, y: .9 },
    { id: "7-49", x: 64., y: . },
    { id: "7-50", x: 69.7, y: 8.7 },
    { id: "7-51", x: 74.3, y: 89.1 },
    { id: "7-52", x: 78.8, y: 89.3 },
    { id: "7-53", x: 78.3, y: 60.0 },
    { id: "7-54", x: 82.9, y: 59.3 },
    { id: "7-55", x: 87.3, y: 58.5 },
    { id: "7-56", x: 91.9, y: 57.8 },
    { id: "7-57", x: 96.2, y: 57.1 },
    { id: "7-58", x: 78.8, y: 64.4 },
    { id: "7-59", x: 83.4, y: 63.2 },
    { id: "7-60", x: 87.8, y: 62.3 },
    { id: "7-61", x: 92.6, y: 61.8 },
    { id: "7-62", x: 96.5, y: 61.2 },
    { id: "7-63", x: 75.3, y: 25.9 },
    { id: "7-64", x: 78.3, y: 26.0 },
    { id: "7-65", x: 75.3, y: 33.9 },
    { id: "7-66", x: 78.1, y: 34.0 },
  ];
  ...
  async function loadOccupied() {
    ...
    try {
      ...
      const r = await fetch(
        `/api/asientos/ocupados-info?piso=7&fecha=${encodeURIComponent(fecha)}`
      );
    ...
    if (cancelMode) {
      ...
      try {
        ...
        const r = await fetch("/api/asientos/cancelar", {
          ...
          body: JSON.stringify({ piso: 7, fecha, asientos, usuario_id: session.id }),
        });
  ...
  floorMap.addEventListener("click", (ev) => {
    ...
    const { x, y } = getPercentCoords(ev);
    const id = `7-${String(nextIdx).padStart(2, "0")}`;
    nextIdx++;
